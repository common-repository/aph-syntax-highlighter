...
Contributors: agusph
Tags: syntax, highlighter, syntax highlighter
...
* Use <a href="https://github.com/syntaxhighlighter/syntaxhighlighter" target"_blank">Syntax Highlighter 4</a> by Alex Gorbatchev
...
* Use similar pattern with <a href="https://wordpress.org/plugins/aph-prism-highlighter/" title="APH Prism Highlighter" target="_blank">APH Prism Highlighter</a> and <a href="https://wordpress.org/plugins/crayon-syntax-highlighter/" title="Crayon Syntax Highlighter" target="_blank">Crayon Syntax Highlighter</a> plugins, so your code will still work using those plugins
...
1. Admin Settings
2. Code Editor
3. Edit code that has been written in the TinyMCE editor
